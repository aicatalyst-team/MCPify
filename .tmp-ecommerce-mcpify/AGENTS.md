...
This MCP server exposes **29 tools** and **0 workflows** to AI agents.

| Permission | Count | Meaning |
|---|---|---|
| ✅ SAFE | 18 | Agent may execute autonomously |
...
- **`CartPage({ items, onCheckout, onRemoveItem, onApplyCoupon }: CartPageProps)`**  
   cart page.
...
```json
{
  "mcpServers": {
    "my-app": {
      "command": "node",
      "args": ["C:\Users\amarn\OneDrive\Desktop\kochi\MCPify\.tmp-ecommerce-mcpify\dist\.tmp-ecommerce-mcpify\server.js"]
    }
  }
}
...
*Generated by MCPify · 2026-06-06T19:35:00.242Z*
