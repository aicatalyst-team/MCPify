...
`;
    ...
    const boundImports = bindableBackendTools(tools).map((t, index) => {
      ...
      return `import { ${t.name} as ${alias} } from '${sourceImportPath(this.outDir, t.filePath)}';`;
    });
